...
@property (nonatomic, strong) WWMonthView *leftView;    //左侧日历
@property (nonatomic, strong) WWMonthView *middleView;  //中间日历
@property (nonatomic, strong) WWMonthView *rightView;   //右侧日历
...
-(void)setType:(CalendarType)type {
    ...
    if (type == CalendarType_Week) {
        ...
        //月
        if (_refreshH) {
            CGFloat viewH = [WWCalendarView getMonthTotalHeight:_currentDate type:CalendarType_Month];
            if (viewH == ViewH) {
                return;
            }
            _refreshH(viewH);
...
- (void)settingScrollView {
    ...
    _leftView = [[WWMonthView alloc] initWithFrame:CGRectMake(0, 0, ViewW, height) Date:
    ...
    _middleView = [[WWMonthView alloc] initWithFrame:CGRectMake(ViewW, 0, ViewW, height) Date:_currentDate];
    ...
    _rightView = [[WWMonthView alloc] initWithFrame:CGRectMake(ViewW * 2, 0, ViewW, height) Date:
